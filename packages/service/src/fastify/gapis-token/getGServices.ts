...
export const getGAuth = async (keyFile: string, scopes = G_SCOPES) =>
...
const colNamesByNumber: string[] = []

export const colIndexToName = (columnNumber: number)  => {
...
export const getGServices = async (keyFile:string, scopes= G_SCOPES) => {
...
export type GServices = Awaited<ReturnType<typeof getGServices>>
