...
import {AttrMeta} from "@shammasov/mydux";
...
export const uploadRaw: FastifyPluginAsync<ServerContext> = async (fastify: FastifyInstance, opts: ServerContext) => {
        ...
        async function (request, reply) {
            ...
            if(data) {
                ...
                var issues: TicketVO[] = json.map( obj => {
                        ...
                        Object.values(TICKETS.attributes).forEach( (p: AttrMeta<any>) => {
...
export const uploadPlugin = fp(uploadRaw)